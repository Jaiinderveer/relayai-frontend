  ...
  return (
    <div className="flex h-full min-h-0 gap-6">
      <div className="flex-1 min-h-0 min-w-0 flex flex-col">
        ...
        {/* Quick Presets — compact, horizontally scrollable, never dominates the thread */}
        <div className="mt-3 mb-2 flex items-center gap-2 overflow-x-auto pb-1 custom-scrollbar">
          ...
          {presets.map((preset, idx) => {
            ...
            return (
              <button
                ...
                disabled={isLoading}
                className="ds-focus-ring shrink-0 flex items-center gap-1.5 bg-surface-2 border border-border text-text-2 text-[12px] font-medium py-1.5 px-3 rounded-full hover:border-accent hover:text-accent transition-all duration-150 cursor-pointer disabled:opacity-50 active:scale-95"
              >
        ...
        >
          ...
          <button
            ...
            className={`ds-focus-ring p-2.5 mx-1 rounded-full transition-all duration-150 cursor-pointer active:scale-90 ${!isSupported && 'opacity-30 cursor-not-allowed'
